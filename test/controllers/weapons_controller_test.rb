...
class WeaponsControllerTest < ActionController::TestCase
  ...
  #     post :create, weapon: { damage: @weapon.damage, name: @weapon.name, zombie_id: @weapon.zombie_id }
  #   end
  # 
  ...
  #   patch :update, id: @weapon, weapon: { damage: @weapon.damage, name: @weapon.name, zombie_id: @weapon.zombie_id }
  #   assert_redirected_to weapon_path(assigns(:weapon))
  # end
  # 
