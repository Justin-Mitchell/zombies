...
# and views
# Read more: http://coffeescript.org/
...
# bundle exec rake doc:rails generates 
# the API under doc/api.
...
group :development, :test do
  ...
  # IRB alterrnative and runtime developer 
  # console
  # Read more: http://pryrepl.org/
  gem 'pry'
